...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public IActionResult Update(int id, CelestialObject updateModel)
        {
            var celestialObject = _context.CelestialObjects.Find(id);
            if (celestialObject == null)
            {
            ...
            celestialObject.Name = updateModel.Name;
            celestialObject.OrbitalPeriod = updateModel.OrbitalPeriod;
            celestialObject.OrbitedObjectId = updateModel.OrbitedObjectId;
